...
export const ThemeProvider = ({ children }) => {
  ...
  function applyTheme(newTheme) {
    ...
    if (newTheme === "light") {
      ...
      htmlElement.style.setProperty("--color-primary", "#6d5ef8");
      ...
      htmlElement.style.setProperty("--color-highlight", "#ffb020");
      ...
      htmlElement.style.setProperty("--color-secondary-foreground", "#6d5ef8");
