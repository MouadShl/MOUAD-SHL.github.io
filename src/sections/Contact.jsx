...
const contactInfo = [
  {
    icon: Mail,
    label: "Email",
    value: "msouhal.dev@gmail.com",
    href: "mailto:msouhal.dev@gmail.com",
  },
  {
    icon: MapPin,
    label: "Location",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        "https://flowform.to/msouhal.dev@gmail.com",
        {
          method: "POST",
          headers: {
